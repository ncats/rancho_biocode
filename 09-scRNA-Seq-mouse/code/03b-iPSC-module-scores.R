...
ggsave("plots/ipsc-feature-plots-1.png", width = 10, height = 8)

FeaturePlot(new, features = names(new@meta.data)[16:24])
ggsave("plots/ipsc-feature-plots-2.png", width = 10, height = 8)

FeaturePlot(new, features = names(new@meta.data)[25:33])
ggsave("plots/ipsc-feature-plots-3.png", width = 10, height = 8)

FeaturePlot(new, features = names(new@meta.data)[34:42])
ggsave("plots/ipsc-feature-plots-4.png", width = 10, height = 8)

FeaturePlot(new, features = names(new@meta.data)[43:44])
ggsave("plots/ipsc-feature-plots-5.png", width = 8, height = 4)
...
markers <- as.list(readWorkbook("./iPSC_Profiler_curated_markers.xlsx", sheet = 1))
